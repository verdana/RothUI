...
assert(oUF, 'oUF Artifact Power was unable to locate oUF install')
...
local function OnEnter(element)
    ...
    GameTooltip:SetOwner(element, 'ANCHOR_TOP')
    GameTooltip:SetText(element.name, ITEM_QUALITY_COLORS[6].r, ITEM_QUALITY_COLORS[6].g, ITEM_QUALITY_COLORS[6].b)
    GameTooltip:AddLine(" ")

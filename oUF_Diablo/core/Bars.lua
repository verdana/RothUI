...
bars.CreateArcaneChargesPowerBar = function(self)
    ...
    local t
    local bar   = CreateFrame("Frame", "oUF_DiabloArcaneChargesPower", self)
    bar.maxOrbs = 4
    local w = 64 * (bar.maxOrbs + 2)
    local h = 64

    bar:SetPoint(self.cfg.arcanecharges.pos.a1,
    self.cfg.arcanecharges.pos.af,
    self.cfg.arcanecharges.pos.a2,
    self.cfg.arcanecharges.pos.x,
    self.cfg.arcanecharges.pos.y)
    bar:SetWidth(w)
    bar:SetHeight(h)

    -- color
    bar.color = self.cfg.arcanecharges.color
    ...
    for i = 1, bar.maxOrbs do
        ...
        orb.fill:SetVertexColor(self.cfg.arcanecharges.color.r,self.cfg.arcanecharges.color.g,self.cfg.arcanecharges.color.b)
        ...
        orb.glow:SetVertexColor(self.cfg.arcanecharges.color.r,self.cfg.arcanecharges.color.g,self.cfg.arcanecharges.color.b)
    ...
    self.ArcaneChargesPowerBar = bar
end

...
func.createAlternativePower = function(self,name)
    ...
    --bar.colorTexture = true --color the altpower bar, removed
...
func.healthPrediction = function(self)
    ...
    mhpb:SetWidth(w)
    mhpb:SetStatusBarTexture(self.cfg.healthprediction.texture)
    mhpb:SetStatusBarColor(self.cfg.healthprediction.color.myself.r,self.cfg.healthprediction.color.myself.g,self.cfg.healthprediction.color.myself.b,self.cfg.healthprediction.color.myself.a)
    -- other heals
    ...
    ohpb:SetWidth(w)
    ohpb:SetStatusBarTexture(self.cfg.healthprediction.texture)
    ohpb:SetStatusBarColor(self.cfg.healthprediction.color.other.r,self.cfg.healthprediction.color.other.g,self.cfg.healthprediction.color.other.b,self.cfg.healthprediction.color.other.a)
    -- Register it with oUF
    self.HealthPrediction = {
        myBar = mhpb,
        otherBar = ohpb,
        maxOverflow = self.cfg.healthprediction.maxoverflow,
    }
end

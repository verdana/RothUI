  ...
  frame:SetPoint("TOPRIGHT",rMM_MinimapClusterDragFrame,"BOTTOMRIGHT",10,-4)
  rCreateDragFrame(frame, dragFrameList, -2 , true) --frame, dragFrameList, inset, clamp
  ...
  MiniMapTrackingBackground:SetColorTexture(20/255,15/255,10/255,1)
  ...
  GameTimeFrameBackground:SetColorTexture(20/255,15/255,10/255,1)

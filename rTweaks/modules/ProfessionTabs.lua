...
function handler:TRADE_SKILL_SHOW(event)
    local owner = ATSWFrame or MRTSkillFrame or SkilletFrame or TradeSkillFrame or TSMCraftingTradeSkillFrame

    if (IsAddOnLoaded("TradeSkillDW") and owner == TradeSkillFrame) or (owner == TSMCraftingTradeSkillFrame) then
